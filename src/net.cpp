...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CryptoBit " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"54.179.165.29", "54.179.165.29"}, //seed node
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CryptoBit is probably already running."), addrBind.ToString().c_str());
        else
